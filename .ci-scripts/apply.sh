...
do
  ...
  terraform workspace select $ENV $shared || terraform workspace new $ENV $shared && terraform workspace select $ENV $shared
...
do
  ...
  terraform workspace select $ENV $feature || terraform workspace new $ENV $feature && terraform workspace select $ENV $feature
